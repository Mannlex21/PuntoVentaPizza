$(document).ready(function() {
	$(document).on('click', '#miCarrito', function(){
		document.getElementById("centrado").innerHTML='';
		document.getElementById("bandera").textContent="4";		
		cambiarColorCarrito();
		
	});
});
function cambiarColorCarrito() {
	//PROMOCIONES	
	...
	carrito.setAttribute('class','quincePixeles selec');
