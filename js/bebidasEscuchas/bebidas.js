$(document).ready(function() {
	$(document).on('click', '#bebidas', function(){
		document.getElementById("centrado").innerHTML='';
		document.getElementById("bandera").textContent="3";		
		cambiarColorBebidas();
		
	});
});
function cambiarColorBebidas() {
	//PROMOCIONES	
	...
	bebidas.setAttribute('class','quincePixeles selec');
	var imgBebidas = document.getElementById('imgBebidasBarra');
	imgBebidas.setAttribute('src','objetos/13-06.png');
